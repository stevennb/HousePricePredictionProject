...
st.markdown("<h4 style = 'margin: -30px; color: #F5F5F5; text-align: center; font-family: Trebuchet MS (sans-serif)': cursive '>Built By Sapphire - DataChicGirl</h4>", unsafe_allow_html = True)
